...
## Core Objectives
1. **Multi-Agent "Mesa de Inversión"**: Implement a specialized multi-agent framework (inspired by TradingAgents) where roles are clearly defined: Macro Analyst, Hypothesis Generator, Bull/Bear Researchers, Risk Manager, and Executioner.
