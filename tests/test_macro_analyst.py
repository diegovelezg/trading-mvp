...
def test_ingest_and_analyze_flow():
    ...
    with patch("macro_analyst.fetch_news") as mock_fetch:
        with patch("macro_analyst.analyze_sentiment") as mock_analyze:
            with patch("macro_analyst.insert_news") as mock_insert_news:
                with patch("macro_analyst.insert_sentiment") as mock_insert_sentiment:
